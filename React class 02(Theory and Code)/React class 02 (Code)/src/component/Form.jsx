...
// }
  return (
    ...
    <form onSubmit={onSubmitHandler}>
        ...
        <div>
        {/* OLD APPROACH ACCESING INPUTS FIELDS VALUES BY PASSING FUNCTION/HANDLERS */}
        {/* <input type="text" onChange={inputHandler}/> */}
        {/* MORDERN/LATEST APPROACH ACCESING INPUTS FIELDS VALUES BY PASSING FUNCTION/HANDLERS */}
